 ...
 */
export const listToCascader = array => {
  let cascaderValue = [];
  let casList1 = [];
  let casList2 = [];
 ...
 */
export const arraySort = (key, sort) => {
  return function(a, b) {
 ...
 */
export const getValueByKey = (array, queryKey, queryValue, getKey) => {
  var getValue = "";
  array.forEach(item => {
 ...
 */
export const setKeyFromTableHeader = tableHeader => {
  // 1.将表头对象放进数组
  var array = []; // 要放进的数组
